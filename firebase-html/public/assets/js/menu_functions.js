function checkCompanyData(dataCompany){
    if(dataCompany){
        ...
        if(errorsCompany != ''){
            setTimeout(() => {showM('Datos de la empresa incompletos: \n'+errorsCompany, 'warning'); }, 1000);
        }
    }
}
...
function addNewArticleNewCustomer(entity, datosEntidadConcreta){
    ...
    if(entity.name == 'articulo'){
        ...
        // showM(valorIva) aqui me falta guardar update este articulo y luego, y que se muestre el tipo adecuado
        currentHtmlEntity = `<div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card shadow mb-4">
